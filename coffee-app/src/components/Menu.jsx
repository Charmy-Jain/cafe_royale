      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {coffeeItems.map((item,index) => (
            <div key={index} className="group relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="relative overflow-hidden">
                ...
                <img src={item.image} alt={item.name} className="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-110"/>
              </div>
              ...
              <div className="p-6 relative">
                ...
                <button className="w-full bg-gradient-to-r from-amber-900 via-amber-800 to-amber-900 text-whitepy-3 px-6 rounded-xl hover:shadow-lg transition-all duration-300 flex justify-center items-center gap-2 font-lato font-semibold group-hover:bg-amber-800">
